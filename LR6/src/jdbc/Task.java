...
public class Task {
    ...
    private static void init(LetterDAO letterDAO, UserDAO userDAO) {
        try {
            ...
            User user1 = new User("Test1", Timestamp.from(formatter.parse("01/01/2001").toInstant()));
            User user2 = new User("Test2", Timestamp.from(formatter.parse("02/02/2002").toInstant()));
            User user3 = new User("Test3", Timestamp.from(formatter.parse("03/03/2003").toInstant()));
            userDAO.add(user1);
            userDAO.add(user2);
            userDAO.add(user3);
            Letter[] letters = {
